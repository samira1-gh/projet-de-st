...
<link rel="stylesheet" type="text/css" href="{$WEB_ROOT}/templates/orderforms/{$carttpl}/css/uhost-style.css" property="stylesheet" />
<script>
                                ...
                                <div class="price-table">
									...
									<div class="de-pricing-bottom">
                                         {if $product.qty eq "0"}
                                            ...
                                            {else}
                                                <a href="{$WEB_ROOT}/cart.php?a=add&amp;{if $product.bid}bid={$product.bid}{else}pid={$product.pid}{/if}" class="btn-custom" id="product{$product@iteration}-order-button">
                                                    {$LANG.ordernowbutton}
                                                </a>
                                        {/if}
									</div>
